...
class PolypeptideElongation(PartitionedProcess):
    ...
    config_schema = {
        ...
        'proteinLengths': 'array[integer[64]]',
        'proteinSequences': 'array[integer[8]]',
        ...
        'translation_aa_supply': 'map[unum[array[float],mol/fg.min]]',
        ...
        'ribosomeElongationRateDict': 'map[unum[float,amino_acid/s]]',
        'uncharged_trna_names': 'array[string]',
        'aaNames': 'list[string]',
        'aa_enzymes': 'array[string]',
        'proton': 'string',
        'water': 'string',
        'cellDensity': 'unum[g/L]',
        'elongation_max': 'unum[aa/s]',
        'aa_from_synthetase': 'array[float]',
        'charging_stoich_matrix': 'array[float[64]]',
    ...
    def outputs(self):
        n_aa = len(self.config.get('amino_acids', []))
        n_trna = len(self.config.get('uncharged_trna_names', []))
        n_importers = len(getattr(self, 'aa_importers', []))
        n_exporters = len(getattr(self, 'aa_exporters', []))
        aa_f = [0.0] * n_aa
        aa_i = [0] * n_aa
        trna_f = [0.0] * n_trna
        trna_i = [0] * n_trna
        return {
            ...
            'listeners': {
                'growth_limits': {
                    ...
                    'synthetase_conc': {'_type': 'overwrite[divide_share[array[float[uM]]]]', '_default': aa_f},
                    'uncharged_trna_conc': {'_type': 'overwrite[divide_share[array[float[uM]]]]', '_default': aa_f},
                    'charged_trna_conc': {'_type': 'overwrite[divide_share[array[float[uM]]]]', '_default': aa_f},
                    'aa_conc': {'_type': 'overwrite[divide_share[array[float[uM]]]]', '_default': aa_f},
                    'ribosome_conc': {'_type': 'overwrite[divide_share[float[uM]]]', '_default': 0.0},
                    'ppgpp_conc': {'_type': 'overwrite[divide_share[float[uM]]]', '_default': 0.0},
                    'rela_conc': {'_type': 'overwrite[divide_share[float[uM]]]', '_default': 0.0},
                    'spot_conc': {'_type': 'overwrite[divide_share[float[uM]]]', '_default': 0.0},
                    # Concentration — millimolar
                    'aa_supply_aa_conc': {'_type': 'overwrite[divide_share[array[float[mM]]]]', '_default': aa_f},
                    # Count deltas and pool sizes (n_aa-length)
                    'aa_count_diff': {'_type': 'overwrite[divide_reset[array[float]]]', '_default': aa_f},
                    'aas_used': {'_type': 'overwrite[divide_share[array[integer[64]]]]', '_default': aa_i},
                    'aa_allocated': {'_type': 'overwrite[divide_share[array[integer[64]]]]', '_default': aa_i},
                    'aa_pool_size': {'_type': 'overwrite[divide_share[array[integer[64]]]]', '_default': aa_i},
                    'aa_request_size': {'_type': 'overwrite[divide_share[array[float]]]', '_default': aa_f},
                    'active_ribosome_allocated': 'overwrite[divide_share[integer]]{0}',
                    ...
                    'aa_supply_fraction_fwd': {'_type': 'overwrite[divide_share[array[float]]]', '_default': aa_f},
                    'aa_supply_fraction_rev': {'_type': 'overwrite[divide_share[array[float]]]', '_default': aa_f},
                    'original_aa_supply': {'_type': 'overwrite[divide_share[array[float]]]', '_default': aa_f},
                    'aa_in_media': {'_type': 'overwrite[divide_share[array[boolean]]]', '_default': [False] * n_aa},
                    'aa_supply': {'_type': 'overwrite[divide_share[array[float]]]', '_default': aa_f},
                    'aa_synthesis': {'_type': 'overwrite[divide_share[array[float]]]', '_default': aa_f},
                    'aa_import': {'_type': 'overwrite[divide_share[array[float]]]', '_default': aa_f},
                    'aa_export': {'_type': 'overwrite[divide_share[array[float]]]', '_default': aa_f},
                    'aa_supply_enzymes_fwd': {'_type': 'overwrite[divide_share[array[float[64]]]]', '_default': aa_i},
                    'aa_supply_enzymes_rev': {'_type': 'overwrite[divide_share[array[float[64]]]]', '_default': aa_i},
                    'aa_importers': {'_type': 'overwrite[divide_share[array[integer[64]]]]', '_default': [0] * n_importers},
                    'aa_exporters': {'_type': 'overwrite[divide_share[array[integer[64]]]]', '_default': [0] * n_exporters},
                    # ppGpp synthesis/degradation rates
                    'rela_syn': {'_type': 'overwrite[divide_share[array[float]]]', '_default': aa_f},
                    'spot_syn': 'overwrite[divide_share[float]]{0.0}',
                    'spot_deg': 'overwrite[divide_share[float]]{0.0}',
                    'spot_deg_inhibited': {'_type': 'overwrite[divide_share[array[float]]]', '_default': aa_f},
                },
                'ribosome_data': {
                    'effective_elongation_rate': {'_type': 'overwrite[divide_share[float[aa/s]]]', '_default': 0.0},
                    'translation_supply': {'_type': 'overwrite[divide_share[array[float]]]', '_default': aa_f},
                    'aa_count_in_sequence': {'_type': 'overwrite[divide_share[array[integer[64]]]]', '_default': aa_i},
                    'aa_counts': {'_type': 'overwrite[divide_share[array[float]]]', '_default': aa_f},
                    'actual_elongations': 'overwrite[divide_share[integer]]{0}',
                    'actual_elongation_hist': {'_type': 'overwrite[divide_share[array[integer[64]]]]', '_default': [0] * 22},
                    'elongations_non_terminating_hist': {'_type': 'overwrite[divide_share[array[integer[64]]]]', '_default': [0] * 22},
                    'did_terminate': 'overwrite[divide_share[integer]]{0}',
                    'termination_loss': 'overwrite[divide_share[integer]]{0}',
                    'num_trpA_terminated': 'overwrite[divide_share[integer]]{0}',
                    'process_elongation_rate': {'_type': 'overwrite[divide_share[float[aa/s]]]', '_default': 0.0},
                },
            },
            'polypeptide_elongation': {
