        ...
        return {
            ...
            'listeners': {
                'growth_limits': {
                    ...
                    'net_charged': {'_type': 'overwrite[array[integer[64]]]', '_default': trna_i},
                    'fraction_trna_charged': {'_type': 'overwrite[array[float]]', '_default': trna_f},
                    'trna_charged': {'_type': 'overwrite[array[integer[64]]]', '_default': trna_i},
                    'ntp_used': {'_type': 'overwrite[array[integer[64]]]', '_default': trna_i},
                    ...
                    'aa_supply_enzymes_fwd': {'_type': 'overwrite[array[float[64]]]', '_default': aa_i},
                    'aa_supply_enzymes_rev': {'_type': 'overwrite[array[float[64]]]', '_default': aa_i},
                    'aa_importers': {'_type': 'overwrite[array[integer[64]]]', '_default': [0] * n_importers},
                    'aa_exporters': {'_type': 'overwrite[array[integer[64]]]', '_default': [0] * n_exporters},
                ...
                'ribosome_data': {
                    ...
                    'aa_count_in_sequence': {'_type': 'overwrite[array[integer[64]]]', '_default': aa_i},
                    'aa_counts': {'_type': 'overwrite[array[float]]', '_default': aa_f},
                    'actual_elongations': 'overwrite[integer]{0}',
                    'actual_elongation_hist': {'_type': 'overwrite[array[integer[64]]]', '_default': [0] * 22},
                    'elongations_non_terminating_hist': {'_type': 'overwrite[array[integer[64]]]', '_default': [0] * 22},
