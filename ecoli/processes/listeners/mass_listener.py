        ...
        return {
            'listeners': {
                'mass': {
                    ...
                    'protein_mass_fraction': 'overwrite[float[dimensionless]]',
                    'rna_mass_fraction': 'overwrite[float[dimensionless]]',
                    'dry_mass_fold_change': 'overwrite[float[dimensionless]]',
                    'protein_mass_fold_change': 'overwrite[float[dimensionless]]',
                    'rna_mass_fold_change': 'overwrite[float[dimensionless]]',
                    'small_molecule_fold_change': 'overwrite[float[dimensionless]]',
                    'expected_mass_fold_change': 'overwrite[float[dimensionless]]',
                },
            },
        }
