        ...
        return {
            'listeners': {
                'mass': {
                    ...
                    'water_mass': 'overwrite[float]',
                    'dry_mass': 'overwrite[float]',
                    'rna_mass': 'overwrite[float]',
                    'rRna_mass': 'overwrite[float]',
                    'tRna_mass': 'overwrite[float]',
                    'mRna_mass': 'overwrite[float]',
                    'dna_mass': 'overwrite[float]',
                    'protein_mass': 'overwrite[float]',
                    'smallMolecule_mass': 'overwrite[float]',
                    'water_mass': 'overwrite[float]',
                    'volume': 'overwrite[float]',
                    'protein_mass_fraction': 'overwrite[float]',
                    'rna_mass_fraction': 'overwrite[float]',
                    'growth': 'overwrite[float]',
                    'instantaneous_growth_rate': 'overwrite[float]',
                    ...
                    'projection_mass': 'overwrite[float]',
                    'cytosol_mass': 'overwrite[float]',
                    'extracellular_mass': 'overwrite[float]',
                    'flagellum_mass': 'overwrite[float]',
                    'membrane_mass': 'overwrite[float]',
                    'outer_membrane_mass': 'overwrite[float]',
                    'periplasm_mass': 'overwrite[float]',
                    'pilus_mass': 'overwrite[float]',
                    'inner_membrane_mass': 'overwrite[float]',
