...
class DnaSupercoiling(Step):
    ...
    def outputs(self):
        return {
            'listeners': {
                'dna_supercoiling': {
                    'segment_left_boundary_coordinates': 'overwrite[divide_share[array[integer]]]',
                    'segment_right_boundary_coordinates': 'overwrite[divide_share[array[integer]]]',
                    'segment_domain_indexes': 'overwrite[divide_share[array[integer]]]',
                    'segment_superhelical_densities': 'overwrite[divide_share[array[float]]]',
                },
            },
        }
