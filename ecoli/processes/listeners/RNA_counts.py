...
class RNACounts(Step):
    ...
    config_schema = {
        ...
        'all_TU_ids': 'array[string]',
        'mRNA_indexes': 'array[integer[64]]',
        'mRNA_TU_ids': 'array[string]',
        'rRNA_indexes': 'array[integer[64]]',
        'rRNA_TU_ids': 'array[string]',
        'all_cistron_ids': 'array[string]',
        'cistron_is_mRNA': 'array[boolean]',
        'mRNA_cistron_ids': 'array[string]',
        'cistron_is_rRNA': 'array[boolean]',
