...
class MetabolismRedux(Step):
    ...
    config_schema = {
        ...
        'non_growth_associated_maintenance': {'_type': 'unum[float,mmol/g/h]', '_default': 8.39 * units.mmol / (units.g * units.h)},
        'avogadro': {'_type': 'unum[float,1/mol]', '_default': 6.02214076e23 / units.mol},
        'cell_density': {'_type': 'unum[float,g/L]', '_default': 1100 * units.g / units.L},
        'dark_atp': {'_type': 'unum[float,mmol/g]', '_default': 33.565052868380675 * units.mmol / units.g},
        'cell_dry_mass_fraction': 'float{0.3}',
        'get_biomass_as_concentrations': {'_type': 'function', '_default': lambda doubling_time: {}},
        'ppgpp_id': 'string{ppgpp}',
        'get_ppGpp_conc': {'_type': 'function', '_default': lambda media: 0.0},
        'exchange_data_from_media': {'_type': 'function', '_default': lambda media: []},
        'get_masses': {'_type': 'function', '_default': lambda exchanges: []},
        'doubling_time': {'_type': 'unum[float,min]', '_default': 44.0 * units.min},
