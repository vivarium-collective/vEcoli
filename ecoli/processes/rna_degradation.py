...
class RnaDegradation(PartitionedProcess):
    ...
    config_schema = {
        ...
        'mature_rna_cistron_indexes': 'array[integer[64]]',
        ...
        'kcat_exoRNase': 'unum[float,1/s]',
        'Kcat_endoRNases': 'unum[array[float],1/s]',
        'charged_trna_names': 'list[string]',
        'uncharged_trna_indexes': 'array[integer[64]]',
        'rna_deg_rates': 'unum[array[float],1/s]',
        'is_mRNA': 'array[integer[64]]',
        'is_rRNA': 'array[integer[64]]',
        'is_tRNA': 'array[integer[64]]',
        'is_miscRNA': 'array[integer[64]]',
        'degrade_misc': 'boolean',
        'rna_lengths': 'array[integer[64]]',
        'nt_counts': 'array[float[64]]',
