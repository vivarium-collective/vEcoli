...
from ecoli.migrated.cell_division import Division, MarkDPeriod, StopAfterDivision
...
# state
from ecoli.migrated.partition import Requester, Evolver
from ecoli.shared.interface import MigrateStep as Step, MigrateProcess as Process
    ...
    def generate_processes_and_steps(
        ...
        for process_name, process_class in config["processes"].items():
            try:
                ...
                print(f"PROCESS: {process_name} needs a CORE. Fix it.")
        ...
        for i in range(1, unique_update_counter):
            steps[f"unique_update_{i}"] = UniqueUpdate(parameters=params)
