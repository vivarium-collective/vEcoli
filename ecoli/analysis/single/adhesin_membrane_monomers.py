...
def plot(
    ...
    cog_M = [
        "EG10168-MONOMER[p]",  # cutE or Int --> [p] = CCO-PERI-BAC
        "EG10671-MONOMER[o]",  # ompF --> [o] = CCO-OUTER-MEM
        "EG10670-MONOMER[o]",  # ompC --> [o] = CCO-OUTER-MEM
        "EG11489-MONOMER[e]",  # csgA
        "EG10315-MONOMER[l]",
        "EG10315_RNA[c]",
        "G6547-MONOMER[l]",  # csgB
        "G6548-MONOMER[p]",  # csgC
        "OMPR-MONOMER[c]",  # ompR
    ]
    ...
    plt.title("UPEC COG M GENES")
    plt.legend(bbox_to_anchor=(1.05, 1), loc=2)
    plt.tight_layout()
    plt.savefig(os.path.join(outdir, "FimH.png"), dpi=300)
    plt.show()
