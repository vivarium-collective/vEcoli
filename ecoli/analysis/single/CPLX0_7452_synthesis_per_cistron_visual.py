...
# for actual RNA synthesis probability per cistron corresponding to the
# final flagellum reaction (CPLX0-7452_RXN), using gene names and the
# same order/layout as the protein-count and mRNA network figures.
...
def plot(
    ...
    df_full = pd.DataFrame(synth_matrix, columns=cistron_ids)
    ...
    gene_name_to_gene_id = {
        ...
        "FLIC": "EG10321",
        "FLID": "EG10841",
        "MOTOR_COMPLEX": None,  # schematic placeholder
        "FLAGELLUM": None,  # schematic placeholder
    }
    ...
    product = "FLAGELLUM"
    rxn_id = "CPLX0_7452_actual_synth_prob_per_cistron"
    ...
    fig, axes, G, pos = plot_stoich_timeseries_network(
        ...
        t=t,
        node_size=0.16,
        title="Final Flagellum Assembly Synthesis Probability",
        figsize=(14, 8),
        force_left_right_grid=True,
