...
# this is the 2.0 version because for the G361 id, the compartment tag changed to j in the new simdata which is odd but it chnaged form c --> j so anything 2.0 is on that
