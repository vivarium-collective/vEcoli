...
def plot(
    ...
    species_to_gene_name = {
        ...
        "G377-MONOMER[c]": "FliI",
        "CPLX0-7451[j]": "Flagellar Export Apparatus",
    }
    ...
    fig, axes, G, pos = plot_stoich_timeseries_network(
        ...
        t=t,
        node_size=0.16,
        title="Flagella Export Apparatus Protein Counts",
        figsize=(14, 8),
        force_left_right_grid=True,
    ...
    if product in axes:
        axes[product].set_title("Export Apparatus", fontsize=9, pad=2)
