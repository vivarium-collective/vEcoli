...
def plot(
    ...
    # List of quorum sensing (QS) molecules of interest to plot
    molecules_qs = [
        "EG12712-MONOMER[c]",
        "G7572-MONOMER[c]",
        "G7575-MONOMER[c]",
    ...
    plt.title("Quroum Sensing Molecules")
    plt.legend(bbox_to_anchor=(1.05, 1), loc=2)
    plt.tight_layout()
    plt.savefig(os.path.join(outdir, "QS_All_Molecules_plot.png"), dpi=300)
    plt.show()

    # Generate and save a separate plot for each QS molecule
    for mol in molecules_qs:
